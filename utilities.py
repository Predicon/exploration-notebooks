...
def get_lender_approved_model_disapproved_reasons(df):
    ...
    return df_lender_reject_model_accept['underwriting_final_decision'].value_counts(), eda.countplot_categorical_columns(df_lender_reject_model_accept, cols = ['underwriting_final_decision'])